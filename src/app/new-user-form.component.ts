  ...
  constructor(private _myService: UserService, private router:Router,
    ...
    onSubmit(){
      console.log("You Registered: " + this.firstname + " " + this.lastname + " " 
         ...
         if(this.mode == 'add')
         this._myService.addUsers(this.firstname, this.lastname, this.username, 
          this.email, this.phonenumber, this.address, this.zipcode,  this.password );
       if(this.mode == 'edit')
  this._myService.updateUser(this.id, this.firstname, this.lastname, this.username, 
  this.email, this.phonenumber, this.address, this.zipcode,  this.password );
